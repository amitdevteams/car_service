 ...
 <div class="left-sidebar-pro">
    <nav id="sidebar" class="">
        <div class="sidebar-header">
            <a href="index.html"><img class="main-logo" src="{{ asset('admin_asset/img/logo/logo.png') }}"
                    alt="" /></a>
            <strong><a href="index.html"><img src="{{ asset('admin_asset/img/logo/logosn.png') }}"
                        alt="" /></a></strong>
        </div>
                ...
                <ul class="metismenu" id="menu1">
                    ...
                    <li>
                        ...
                        <ul class="submenu-angle" aria-expanded="false">
                            ...
                            <li><a title="Add Professor" href="{{ route('admin.title')}}"><span class="mini-sub-pro">Add
                                        Slider content</span></a></li>
